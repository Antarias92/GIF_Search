...
async function renderCats(){
    let response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=${apiKey}&q=cats&limit=36`); 
...
async function renderDogs(){
    ...
    console.log("Requesting Data");
    let response = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=${apiKey}&q=dogs&limit=36`);
